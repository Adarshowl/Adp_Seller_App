...
export const BASE_URL = 'https://nervous-jang.212-227-236-230.plesk.page/api/';
...
export const API_END_POINTS = {
  ...
  CURRENCY_APP:
    'https://nervous-jang.212-227-236-230.plesk.page/api/currency/get-admin-currency',
  ...
  assignDeliveryBoyToOrder: 
    'https://nervous-jang.212-227-236-230.plesk.page/api/app_sellerorder/assign-order-to-delivery-boy',
