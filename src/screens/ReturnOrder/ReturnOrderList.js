...
const ReturnOrderList = ({item}) => {
  ...
  const handleSubmission = () => {
    ...
    try {
      ...
      // console.log(body)
      // console.log("response axios >>> ", JSON.stringify(API_END_POINTS.Return_Order_Update_Status));
      ApiCall('post', body, API_END_POINTS.Return_Order_Update_Status, {
  ...
  return (
    <TouchableOpacity
      // onPress={handleOpen}
      onPress={() => {
        navigation.navigate('ReturnOrderDetails', {item});
      }}
      activeOpacity={0.8}
      style={[
        styles.wrapper,
          ...
          <View style={styles.modalBackground}>
            <View style={styles.modalContent}>
              <View>
                ...
                {/* <Text
                  numberOfLines={3}
                  style={styles.refundText}>"{item?.return_reason}"</Text> */}
              </View>
